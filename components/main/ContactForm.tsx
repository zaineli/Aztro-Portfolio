      ...
      <div className="container bg-white bg-opacity-10 p-6 rounded-tl-xl rounded-bl-xl shadow-lg flex-1">
        ...
        <form>
          ...
          >
            <div className=" rounded-lg grid grid-cols-2 gap-6">
              <input type="text" placeholder="Full Name" className=" input w-full p-2 rounded-lg" />
              <input type="text" placeholder="Street" className=" input p-2 rounded-lg" />
              ...
              <input type="number" placeholder="Phone No." className=" p-2 flex-1 rounded-lg input " />
              <input type="email" placeholder="Email" className=" p-2 flex-1 rounded-lg input" />
            </div>
            <textarea placeholder="Write Message" className=" p-2 rounded-lg input textarea w-full"></textarea>
          </motion.div>
          <motion.button 
            type="button" 
        ...
        >
          ...
          <li className="flex items-center text-white hover:text-blue-500">
            ...
            <a href="tel:+158996888" className="text-white">+158 996 888</a>
          </li>
        </motion.ul>
      </div>
      </div>
